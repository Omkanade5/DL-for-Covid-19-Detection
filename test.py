...
message = tk.Label(window, text="DL Soln for Covid-19 Detection", bg="snow", fg="black", width=48,
                   height=5, font=('times', 30, 'italic bold '))
...
def model_predict():
    ...
    global rst
    rst = tk.Label(text='RESULT\n\n '+  final_prediction.upper(), background="snow",fg="Black", font=("", 15,'bold'))
